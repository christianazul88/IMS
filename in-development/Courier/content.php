                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="py-1 px-0 d-flex align-items-center">
                                    ...
                                    <a href="../config/delete.php?from=courier&id=<?php echo $row['hashed_id'];?>" class="btn btn-transparent text-danger ms-1 custom-clicked" ><span class="far fa-trash-alt"></span></a>
                                </td>
                            </tr>
                            <?php
                            }
...
<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
    <div class="modal-content position-relative">
      ...
      <form id="update-form" action="../config/update-admin.php?type=courier" method="POST">
        <div class="modal-body p-0">
            <div class="rounded-top-3 py-3 ps-4 pe-6 bg-body-tertiary">
...
<script>
    $(document).ready(function() {
        $("#update-form").on("submit", function(e) {
            ...
            Swal.fire({
                title: "Are you sure?",
                text: "Do you want to update this courier?",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: "Processing...",
                        text: "Please wait while updating the courier.",
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            Swal.fire({
                                title: "Updated!",
                                text: "courier has been successfully updated.",
                                icon: "success",
                                timer: 2000,
