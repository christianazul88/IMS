    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="../index.html"><img class="me-2" src="../../assets/img/logo/LPO Logo.png" alt="" width="120" /></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div>
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">Please Wait while I generate all the barcodes.</p>
                <hr />
                <p>Generating barcodes may take some time, depending on the number of unique barcodes being created. This process could take anywhere from a minute to an hour, especially if generating around 10,000 unique barcodes. Please do not click any buttons or close this window while the barcodes are being generated.

                <br><br>If a ZIP file has already been downloaded, click the button below. Otherwise, please refresh this window to begin the process again.</p>
