    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="../dashboard/"><img class="me-2" src="../../assets/img/logo/LPO Logo.png" alt="" width="58" /><span class="font-sans-serif text-secondary fw-bolder fs-4 d-inline-block">IMS</span></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="fw-black lh-1 text-300 fs-error">500</div>
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold">Whoops, Attempting to visit Unauthorized page?</p>
                <hr />
                <p>Try going back or go to <a href="../dashboard/">Dashboard</a>.</p>
              </div>
            </div>
          </div>
        </div>
