                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="py-1 px-0 d-flex align-items-center">
                                    ...
                                    <a href="../config/delete.php?from=platform&id=<?php echo $row['hashed_id'];?>" class="btn btn-transparent text-danger ms-1 custom-clicked" ><span class="far fa-trash-alt"></span></a>
                                </td>
                            </tr>
                            <?php
                            }
