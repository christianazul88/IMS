<div class="row">
                ...
                <form action="../Transaction-overview/index" method="POST">
                    <div class="tab-content row">
                        <div class="col-lg-2 mb-3">
                            <label class="fs--6" for="barcode_keyword">Filter by Barcode</label>
                            <input type="text" name="barcode_keyword" id="barcode_keyword" class="form-control fs-11" />
                        </div>
                        <div class="col-lg-2 mb-3">
                        ...
                        <div class="col-lg-2 mb-3">
                            ...
                            <select class="form-select selectpicker fs-11" id="staff_name" multiple="multiple" size="1" name="multiple_users[]" data-options='{"placeholder":"Select your options"}'>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $barcode_keyword = isset($_POST['barcode_keyword']) ? trim($_POST['barcode_keyword']) : '';
        ...
        $multiple_users = isset($_POST['multiple_users']) ? $_POST['multiple_users'] : [];
        ...
        $imploded_users = implode(', ', $multiple_users);
        ...
        <div class="card mt-3">
            <div class="card-body bg-body-tertiary">
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <a href="url.php?from=<?php echo $startDate;?>&to=<?php echo $endDate;?>&staffs=<?php echo $imploded_users;?>&bc=<?php echo $barcode_keyword;?>&wh=<?php echo $warehouse_transaction;?>" class="btn btn-primary fs-11"><span class="fas fa-download"></span></a>
                    </div>
                </div>
                <!-- <div class="row mt-3">
                    <div class="col-lg-12">
                            ...
                            <table class="table mb-0 data-table fs-10" data-datatables="data-datatables">
                                ...
                                <?php
                                        ...
                                        if (!empty($barcode_keyword)) {
                                            $additional = "AND oc.unique_barcode LIKE '%$barcode_keyword%'";
                                        } else {
                                            $additional ='';
                                        }
                                        $query = "
                                        SELECT oc.unique_barcode, oc.sold_price, p.description, b.brand_name, c.category_name, s.capital, p.keyword, ol.hashed_id AS outbound_id, ol.date_sent, w.warehouse_name, ol.customer_fullname, cr.courier_name, lp.logistic_name, ol.order_num, ol.order_line_id, u.user_fname, u.user_lname, ol.user_id AS outbounder
                                        ...
                                        WHERE ol.date_sent BETWEEN '$startDate' AND '$endDate' AND ol.warehouse = '$warehouse_transaction' $additional
                                        ";
                                        ...
                                        if($result->num_rows>0){
                                            while($row=$result->fetch_assoc()){
                                                ...
                                                if(!empty($imploded_users)){
                                                    if(strpos($imploded_users, $outbounder)!==false){
                                                        ?>
                                                        <tr>
                                                            <td></td>
