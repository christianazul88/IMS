<div class="card shadow-sm">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info text-start">
            ...
            Generates a downloadable summary of inbound stocks per supplier (International and Local) for a selected warehouse.  
            The report covers transactions from the start of the previous month up to the current date, showing:
            <ul class="mb-0 mt-2">
                <li>Total quantity received per supplier</li>
                <li>Total capital amount per supplier</li>
            </ul>
        </div>

        <!-- ✅ Form -->
        <form action="../Inbound-Summary/index.php" method="POST">
        ...
        <div class="text-center mt-4">
            <div class="alert alert-success">
                Report generated successfully. Download the inbound summary CSV below.
            </div>
