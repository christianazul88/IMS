...
png('crawler',p=>{p.disk(64,65,36,[43,24,58]);p.disk(64,53,24,[238,102,79]);p.rect(20,76,88,11,[23,18,32]);p.rect(35,45,8,8,dark);p.rect(78,45,8,8,dark);p.rect(19,83,22,9,red);p.rect(87,83,22,9,red)});
png('wisp',p=>{p.disk(64,64,39,[102,60,166,130]);p.disk(64,59,23,[190,130,255]);p.disk(55,57,5,dark);p.disk(74,57,5,dark);p.rect(42,82,44,12,[80,43,130]);});
png('brute',p=>{p.disk(64,72,49,[71,35,42]);p.rect(27,57,74,56,[151,55,57]);p.disk(64,37,29,[241,158,88]);p.rect(48,38,8,8,dark);p.rect(73,38,8,8,dark);p.rect(16,70,25,29,[35,24,33]);p.rect(88,70,25,29,[35,24,33])});
png('boss-knight',humanoid([112,60,85],[p=>{p.rect(34,10,60,16,[180,184,202]);p.rect(88,46,30,12,[225,190,83]);p.rect(40,70,12,37,[60,68,93])}]));
png('boss-beast',p=>{p.disk(64,67,53,[48,76,51]);p.disk(64,50,33,[105,163,79]);p.rect(18,75,92,23,[30,49,36]);p.rect(27,30,19,19,[223,84,75]);p.rect(82,30,19,19,[223,84,75]);p.rect(52,51,8,8,dark);p.rect(72,51,8,8,dark);p.rect(40,85,48,15,gold)});
png('boss-oracle',p=>{p.disk(64,67,50,[51,47,93,170]);p.rect(30,58,68,53,[95,69,164]);p.disk(64,38,27,[192,183,246]);p.rect(48,38,7,7,dark);p.rect(74,38,7,7,dark);p.rect(47,11,34,14,[231,218,255]);p.disk(20,58,14,[112,215,249]);p.disk(108,58,14,[112,215,249])});
...
png('imp',p=>{p.disk(64,74,34,[74,10,22]);p.disk(64,47,23,[120,20,30]);p.rect(47,28,9,15,[40,20,14]);p.rect(72,28,9,15,[40,20,14]);p.rect(41,41,7,7,[255,210,80]);p.rect(80,41,7,7,[255,210,80]);p.rect(16,58,24,30,[40,10,16]);p.rect(88,58,24,30,[40,10,16]);p.rect(50,94,10,20,[24,8,12]);p.rect(68,94,10,20,[24,8,12]);p.rect(46,60,36,22,[54,14,20])});
...
for(const state of ['idle','attack','laser','stomp','summon'])for(let f=0;f<6;f++)png(`demon-${state}-${f+1}`,demonFrame(state,f));
...
console.log('Created editable PNGs: allies, enemies, weapons, three-head Demon Lord core/flank frame sets, rockets, and beam textures.');
