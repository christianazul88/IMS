<div class="row">
    ...
    <?php
        ...
        $_SESSION['finance_warehouse_transaction'] = $warehouse_transactions; // Store the warehouse transaction in session
        ...
        $_SESSION['finance_categories'] = $imploded_category; // Store the imploded categories in session
        ...
        $_SESSION['finance_suppliers'] = $imploded_supplier; // Store the imploded suppliers in session
        ...
        if($warehouse_transaction !== "ALL" && !empty($warehouse_transaction)){
            ...
            $transaction_warehouse_name = "All Accessible Warehouses";
        }
        $transaction_warehouse_query = "SELECT warehouse_name FROM warehouse WHERE hashed_id = '$warehouse_transaction' LIMIT 1";
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-lg-11 text-center">
                        <h2 class="mb-0">Finance Report</h2>
                        <h5 class="mt-0 mb-0"><?php echo $transaction_warehouse_name; ?></h5>
                        <span class="text-muted fs-11 mt-0">From <?php echo $formatted_startDate; ?> to <?php echo $formatted_endDate; ?></span>
                        <br>
                        <span class="fs-11 mt-0 text-danger">Note: Showing only up to 20 records.</span>
                    </div>
                    <div class="col-lg-1">
